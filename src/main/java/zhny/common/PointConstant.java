...
public interface PointConstant {
    ...
    String POINTCOUNT_48 = "48";
    String POINTCOUNT_96 = "96";
    String POINTCOUNT_144 = "144";
    String POINTCOUNT_288 = "288";
    String[] POINTCOUNT_24_ARR = {"00"};
    String[] POINTCOUNT_48_ARR = {"00",  "30"};
    String[] POINTCOUNT_96_ARR = {"00", "15", "30", "45"};
    String[] POINTCOUNT_144_ARR = {"00", "10", "20", "30", "40", "50"};
    ...
    List<String> POINTCOUNT_48_LIST = new ArrayList<>(Arrays.asList(POINTCOUNT_48_ARR));
    List<String> POINTCOUNT_96_LIST = new ArrayList<>(Arrays.asList(POINTCOUNT_96_ARR));
    List<String> POINTCOUNT_144_LIST = new ArrayList<>(Arrays.asList(POINTCOUNT_144_ARR));
